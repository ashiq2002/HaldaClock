...
class ProgressiveClock extends StatefulWidget {
  ...
  @override
  _ProgressiveClockState createState() =>
      _ProgressiveClockState();
}

class _ProgressiveClockState extends State<ProgressiveClock>
  ...
  void _checkIfNeedCancelAnimation(ProgressiveClock oldWidget) {
  ...
  @override
  void didUpdateWidget(ProgressiveClock oldWidget) {
                ...
                child: Transform.rotate(
                  ...
                  child: Transform.rotate(
                    ...
                    child: Transform.translate(
                      offset: Offset(
                        (widget.circularStrokeCap != CircularStrokeCap.round)
                            ? widget.lineWidth / 2
                            : 0,
